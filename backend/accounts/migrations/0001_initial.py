    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('civilite', models.CharField(choices=[('I', 'Indéterminé'), ('F', 'Féminin'), ('M', 'Masculin')], max_length=2, verbose_name='civilité')),
            ...
            options={
                'permissions': [('can_change_qualify_identity', 'Can change qualify identity'), ('can_set_statut_provisoire', 'Can set identities status to temporary'), ('can_view_detail_patient', 'Can view patient detail')],
            },
        ),
        migrations.CreateModel(
            name='Utilisateur',
